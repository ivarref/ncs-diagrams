...
function get_data_actual(reserves, callback) {
    d3.csv("https://raw.githubusercontent.com/ivarref/ncs-raw-data/master/data/fpm.csv", function(data) {
        ...
        parsed_data = newdata
        maxDate = d3.max(newdata, function(d) { return d.date })
        console.log(maxDate)
...
function get_data(data_callback) {
    if (parsed_data != null) {
        ...
        get_reserves_map('https://raw.githubusercontent.com/ivarref/ncs-raw-data/master/data/field_reserves.csv', {}, function(reserves) {
          get_reserves_map('https://raw.githubusercontent.com/ivarref/ncs-raw-data/master/data/field_reserves_extra.csv', reserves, function(r) {
            get_data_actual(r, function(dat) {
              data_callback(getCorrectResourceTypes(dat))
            }); 
          }); 
        });
    }
