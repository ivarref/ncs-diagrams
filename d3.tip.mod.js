...
d3.tip = function() {
  ...
  tip.show = function() {
    ...
    coords = coords_fn==null ? direction_callbacks.get(dir).apply(this) : coords_fn(getScreenBBox(), node)
  ...
  function getScreenBBox() {
    var target     = d3.event.target.ownerSVGElement,
        bbox       = {},
